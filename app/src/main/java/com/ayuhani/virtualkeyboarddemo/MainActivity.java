...
public class MainActivity extends AppCompatActivity implements KeyboardAdapter.OnKeyboardClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TextWatcher方式
        etInput.addTextChangedListener(new MoneyTextWatcher(etInput).setDigits(2));

        //setFilters方式
//        etInput.setFilters(new InputFilter[]{new MoneyValueFilter().setDigits(2)});
